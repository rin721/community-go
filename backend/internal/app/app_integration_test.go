...
func TestWebInitialSetupRunsSharedInitialization(t *testing.T) {
	...
	accessCookie := requireResponseCookie(t, setupRecorder, "console_access")
	requireResponseCookie(t, setupRecorder, "console_refresh")
	requireResponseCookie(t, setupRecorder, "console_csrf")
...
func TestSetupCenterRunEndpointInitializesSystem(t *testing.T) {
	...
	requireResponseCookie(t, setupRecorder, "console_access")
	requireResponseCookie(t, setupRecorder, "console_refresh")
	requireResponseCookie(t, setupRecorder, "console_csrf")
...
func TestAuthHTTPFlowMatchesReactContracts(t *testing.T) {
	...
	requireResponseCookie(t, loginRecorder, "console_access")
	loginRefreshCookie := requireResponseCookie(t, loginRecorder, "console_refresh")
	loginCSRFCookie := requireResponseCookie(t, loginRecorder, "console_csrf")
	...
	refreshAccessCookie := requireResponseCookie(t, refreshRecorder, "console_access")
	refreshRefreshCookie := requireResponseCookie(t, refreshRecorder, "console_refresh")
	...
	requireResponseCookie(t, memberLoginRecorder, "console_access")
	requireResponseCookie(t, memberLoginRecorder, "console_refresh")
}
