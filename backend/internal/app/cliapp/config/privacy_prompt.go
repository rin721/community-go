...
func PromptCoreSecretRecovery(ctx *cli.Context, configPath string) (bool, error) {
	...
	case privacyCoreActionGenerateFile:
		...
		if err := writeConfigPromptInfo(ctx, localizer.T("cli.config.privacy.core.info.generated"), "write IAM core secret generated notice"); err != nil {
			return false, err
		}
		return true, nil
	case privacyActionRuntimeEnvOnly:
		...
		if err := writeConfigPromptInfo(ctx, localizer.T("cli.config.privacy.core.info.runtimeEnv"), "write IAM core secret runtime env notice"); err != nil {
			return false, err
		}
		return true, nil
...
func promptAndWriteCoreSecrets(ctx *cli.Context, configPath string) (bool, error) {
	...
	if err := writeConfigPromptInfo(ctx, localizer.T("cli.config.privacy.core.info.written"), "write IAM core secret file notice"); err != nil {
		return false, err
	}
	return true, nil
}
