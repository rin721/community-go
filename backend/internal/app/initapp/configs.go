...
func IsIAMRuntimeConfigChanged(oldCfg, newCfg *config.Config) bool {
	...
	return oldCfg.Auth.RegistrationMode != newCfg.Auth.RegistrationMode ||
		...
		oldCfg.Auth.NotificationRetryIntervalSeconds != newCfg.Auth.NotificationRetryIntervalSeconds ||
		oldCfg.Auth.NotificationRetryMaxAttempts != newCfg.Auth.NotificationRetryMaxAttempts ||
