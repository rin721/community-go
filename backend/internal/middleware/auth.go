...
type Authorizer interface {
	Authorize(context.Context, authtypes.Principal, authtypes.PermissionContext) (bool, error)
}
...
func RequirePermission(authorizer Authorizer, permission authtypes.PermissionContext, next ports.HTTPHandlerFunc) ports.HTTPHandlerFunc {
	return func(c ports.HTTPContext) {
		if authorizer == nil {
...
func GetPrincipal(c ports.HTTPContext) (authtypes.Principal, bool) {
