...
const (
	...
	NotificationOutboxKindInvitation        = "invitation"
	NotificationOutboxKindPasswordReset     = "password_reset"
	NotificationOutboxKindEmailVerification = "email_verification"

	NotificationOutboxResourceInvitation        = "invitation"
	NotificationOutboxResourcePasswordReset     = "password_reset"
	NotificationOutboxResourceEmailVerification = "email_verification"

	NotificationOutboxStatusPending = StatusPending
...
type NotificationOutbox struct {
	...
	URL           string     `gorm:"column:url;not null" json:"-"`
	ResourceType  string     `gorm:"column:resource_type;size:64;not null;index:idx_iam_notification_outbox_resource" json:"resourceType"`
	ResourceID    int64      `gorm:"column:resource_id;not null;index:idx_iam_notification_outbox_resource" json:"resourceId,string"`
	Status        string     `gorm:"column:status;size:32;not null;index" json:"status"`
	Attempts      int        `gorm:"column:attempts;not null;default:0" json:"attempts"`
	MaxAttempts   int        `gorm:"column:max_attempts;not null;default:5" json:"maxAttempts"`
	NextAttemptAt time.Time  `gorm:"column:next_attempt_at;not null;index" json:"nextAttemptAt"`
	LastError     string     `gorm:"column:last_error;not null" json:"lastError"`
	SentAt        *time.Time `gorm:"column:sent_at" json:"sentAt,omitempty"`
	CreatedAt     time.Time  `gorm:"column:created_at" json:"createdAt"`
	UpdatedAt     time.Time  `gorm:"column:updated_at" json:"updatedAt"`
}

func (NotificationOutbox) TableName() string { return "iam_notification_outbox" }
