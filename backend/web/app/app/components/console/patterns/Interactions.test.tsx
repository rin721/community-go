...
import { SkeletonText } from "~/components/console/primitives/Skeleton";
import { Collapse } from "./Collapse";
import { Dialog } from "./Dialog";
import { Drawer } from "./Drawer";
import { Popover } from "./Popover";

describe("platform interaction patterns", () => {
  it("renders skeleton text placeholders without exposing loading copy", () => {
    const { container } = render(<SkeletonText lines={3} />);

    expect(container.querySelectorAll(".console-skeleton-text__line")).toHaveLength(3);
  });
