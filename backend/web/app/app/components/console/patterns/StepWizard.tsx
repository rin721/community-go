...
export function StepWizard({
  ...
  return (
    <nav className={cn("console-step-wizard", className)} aria-label={ariaLabel}>
      <div className="console-step-wizard__summary">
        <span>{progressLabel}</span>
        <div
          className="console-step-wizard__progress"
      ...
      <ol className="console-step-wizard__list">
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              <button
                className="console-step-wizard__button"
              ...
              >
                <span className="console-step-wizard__icon" aria-hidden="true">
                  <Icon size={18} />
                </span>
                <span className="console-step-wizard__body">
                  <span className="console-step-wizard__title">{item.title}</span>
                  {item.description ? (
                    <span className="console-step-wizard__description">{item.description}</span>
                  ) : null}
                </span>
                <span className="console-step-wizard__status">{item.statusLabel}</span>
              </button>
            </li>
          );
        })}
