...
describe("auth schemas", () => {
  ...
  it("keeps validation resources available in both locales", () => {
    expect(resources["en-US"].errors.validation.captchaCode).toBeTruthy();
    expect(resources["en-US"].errors.validation.mfaCode).toBeTruthy();
    expect(resources["en-US"].errors.validation.resetToken).toBeTruthy();
