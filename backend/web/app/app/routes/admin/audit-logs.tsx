...
const maxLimit = 500;
const auditLogErrorCopy = {
  defaultTitle: "admin.auditLogs.states.errorTitle",
  permissionDescription: "admin.auditLogs.states.permissionDescription",
  permissionTitle: "admin.auditLogs.states.permissionTitle",
};
...
export default function AdminAuditLogsRoute() {
  ...
  const auditLogColumns = useMemo<ColumnDef<IAMAuditLog>[]>(
    () => [
      ...
      {
        accessorKey: "action",
        cell: ({ row }) => <code className="console-audit-action">{row.original.action}</code>,
        header: t("admin.auditLogs.columns.action"),
      },
      {
        id: "resource",
        cell: ({ row }) => (
          <div className="console-audit-resource">
      ...
      },
      {
        id: "user",
        cell: ({ row }) => (
          <div className="console-audit-user">
      ...
      },
      {
        ...
        cell: ({ row }) =>
          row.original.ipAddress ? (
            <code className="console-audit-code">{row.original.ipAddress}</code>
          ) : (
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <span className="console-audit-agent">
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <pre className="console-audit-metadata">{prettyMetadata(row.original.metadata, t)}</pre>
        ),
  ...
  return (
    <section className="console-admin-dashboard" aria-labelledby="admin-audit-logs-title">
      ...
      {auditLogsQuery.error ? (
        <StateBlock
          intent="danger"
          title={adminErrorTitle(auditLogsQuery.error, t, auditLogErrorCopy)}
          description={adminErrorDescription(auditLogsQuery.error, t, auditLogErrorCopy)}
        />
      ) : null}

      <div className="console-admin-stat-grid" aria-label={t("admin.auditLogs.summaryLabel")}>
        <AuditStatCard
      ...
      <section className="console-admin-panel">
        <header className="console-admin-panel-header-row">
          ...
          <span className="console-iam-audit-count">
        ...
        {auditLogsQuery.isLoading ? (
          ...
          <div className="console-audit-table">
            <DataTable
