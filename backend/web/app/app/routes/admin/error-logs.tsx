...
const errorLogErrorCopy = {
  defaultTitle: "admin.errorLogs.states.errorTitle",
  permissionDescription: "admin.errorLogs.states.permissionDescription",
  permissionTitle: "admin.errorLogs.states.permissionTitle",
  storageUnavailableDescription: "admin.errorLogs.states.storageUnavailableDescription",
  storageUnavailableTitle: "admin.errorLogs.states.storageUnavailableTitle",
};
...
export default function AdminErrorLogsRoute() {
  ...
  return (
    <section className="console-admin-dashboard" aria-labelledby="admin-error-logs-title">
      ...
      {errorLogsQuery.error ? (
        <StateBlock
          intent="danger"
          title={adminErrorTitle(errorLogsQuery.error, t, errorLogErrorCopy)}
          description={adminErrorDescription(errorLogsQuery.error, t, errorLogErrorCopy)}
        />
      ) : null}

      <div className="console-admin-stat-grid" aria-label={t("admin.errorLogs.summaryLabel")}>
        <ErrorLogStatCard
          icon={<Bug size={19} />}
      ...
      <section className="console-admin-panel">
        <header className="console-admin-panel-header-row">
          ...
          <div className="console-admin-pager" aria-label={t("admin.errorLogs.pagination.label")}>
            <Button
              appearance="secondary"
        ...
        {errorLogsQuery.isLoading ? (
          ...
          <>
            ...
            <div className="console-error-log-table">
              <DataTable
...
function ErrorSummary({
  ...
  if (!value) {
    return <span className="console-operation-muted">{t("admin.errorLogs.labels.noSummary")}</span>;
  }

  return <code className="console-error-log-summary">{previewPayload(value)}</code>;
}
