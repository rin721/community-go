...
const iamErrorCopy = {
  defaultTitle: "admin.iam.states.errorTitle",
  permissionDescription: "admin.iam.states.permissionDescription",
  permissionTitle: "admin.iam.states.permissionTitle",
};
...
export default function AdminIAMRoute() {
  ...
  return (
    <section className="console-admin-dashboard" aria-labelledby="admin-iam-title">
      ...
      {firstError ? (
        <StateBlock
          intent="danger"
          title={adminErrorTitle(firstError, t, iamErrorCopy)}
          description={adminErrorDescription(firstError, t, iamErrorCopy)}
        />
      ) : null}

      <div className="console-admin-stat-grid" aria-label={t("admin.iam.summaryLabel")}>
        <IAMStatCard
      ...
      <section className="console-admin-panel console-admin-panel--span-2">
        ...
        {usersQuery.isLoading ? (
          ...
          <div className="console-iam-table console-iam-table--members">
            <DataTable
      ...
      <div className="console-admin-server-grid">
        <section className="console-admin-panel">
          <header>
          ...
          {rolesQuery.isLoading ? (
            ...
            <div className="console-iam-table console-iam-table--roles">
              <DataTable
                columns={roleColumns}
        ...
        <section className="console-admin-panel">
          ...
          {sessionsQuery.isLoading ? (
            ...
            <div className="console-iam-table console-iam-table--sessions">
              <DataTable
      ...
      <section className="console-admin-panel">
        ...
        {auditLogsQuery.isLoading ? (
          ...
          <div className="console-iam-table console-iam-table--audit">
            <DataTable
...
function PrincipalCell({
  ...
  return (
    <div className="console-iam-principal">
...
function RoleList({ roles }: { roles: string[] }) {
  ...
  return (
    <div className="console-iam-role-list">
      {roles.map((role) => (
