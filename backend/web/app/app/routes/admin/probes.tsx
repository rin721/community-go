...
export default function AdminProbesRoute() {
  ...
  return (
    <section className="console-admin-dashboard" aria-labelledby="admin-probes-title">
      ...
      <div className="console-admin-stat-grid" aria-label={t("admin.probes.summaryLabel")}>
        <ProbeMetricCard
      ...
      <div className="console-probe-grid">
        ...
        <section className="console-admin-panel">
          ...
          {readyError ? (
            ...
            <>
              ...
              />
              <div className="console-probe-checks" aria-label={t("admin.probes.checks.label")}>
                ...
                {readyChecks.length > 0 ? (
                  <dl>
                    {readyChecks.map(([name, value]) => {
                      ...
                      return (
                        <div key={name} className="console-probe-check">
                          <dt>{name}</dt>
                          <dd>
                            <span className="console-probe-status" data-state={state}>
...
function ProbePanelHeader({
  ...
  return (
    <header className="console-probe-header">
      <div className="console-probe-heading">
        <span aria-hidden="true">{icon}</span>
        <div>
          <h2>{title}</h2>
          <p>{description}</p>
      ...
      <div className="console-probe-header__meta">
        <code>{endpoint}</code>
        <span className="console-probe-status" data-state={state}>
          {status}
        </span>
...
function KeyValueList({ items }: { items: Array<[string, string]> }) {
  return (
    <dl className="console-admin-key-values">
