...
import { createPasswordResetSchema, type PasswordResetFormValues } from "~/features/auth/schemas";
...
export default function PasswordResetRoute() {
  ...
  return (
    <main className="console-auth-page">
      <section className="console-auth-card" aria-labelledby="password-reset-title">
        ...
        <ConsoleForm form={form} onSubmit={onSubmit}>
          <ConsoleTextField<PasswordResetFormValues>
            autoComplete="off"
