...
export default function SignupRoute() {
  ...
  if (publicSettings.isLoading) {
    return (
      <main className="console-auth-page">
        <section className="console-auth-card" aria-labelledby="signup-loading-title">
          <StateBlock
  ...
  if (publicSettings.isError) {
    return (
      <main className="console-auth-page">
        <section className="console-auth-card" aria-labelledby="signup-error-title">
          <StateBlock
            intent="danger"
  ...
  return (
    <main className="console-auth-page">
      <section className="console-auth-card" aria-labelledby="signup-title">
        ...
        {verificationPending ? (
          ...
          <ConsoleForm form={form} onSubmit={onSubmit}>
            <ConsoleTextField<SignupFormValues>
              autoComplete="email"
...
function SignupDebugDelivery({ delivery }: { delivery: NotificationDelivery }) {
  ...
  return (
    <div className="console-auth-debug" aria-label={t("auth.signup.debugTitle")}>
      {delivery.token ? (
        <div>
