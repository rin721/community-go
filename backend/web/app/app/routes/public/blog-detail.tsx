...
import { MarkdownProse } from "~/components/console/patterns/MarkdownProse";
  ...
  return (
    <main className="console-page console-page--narrow">
      <header className="console-article-header">
        ...
        <dl className="console-article-header__meta">
          <div>
      ...
      <img className="console-article-cover" src={post.cover} alt={post.title} />
