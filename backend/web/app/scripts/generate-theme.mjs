...
const tokensOutputPath = join(appDir, "components", "console", "tokens", "tokens.css");
...
if (!checkOnly) {
  console.log(`Generated theme '${config.activeThemeId}'.`);
}
...
function renderMetadata(theme, activeThemeId) {
  return [
    ...
    `export const activeThemePackage = ${JSON.stringify(theme, null, 2)} satisfies ConsoleThemePackage;`,
