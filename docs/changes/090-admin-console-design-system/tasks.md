...
- [x] PATTERN-090-001 实现 ResourceIndex、QueryToolbar、ActiveFilters、DataGrid/RecordList、SelectionBar；前置：FE-090-003、SHELL-090-002；完成证据：`ResourceIndex`、`FilterBar`、`DataTable`、`BulkActionBar` 已复用，筛选 URL 状态与数据表增强测试通过。
