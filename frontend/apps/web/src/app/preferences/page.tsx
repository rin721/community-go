...
import type { PreferencesInput } from '@community-go/schemas';
...
const resolvePreferences: Resolver<PreferencesInput> = async (values, context, options) => {
  const [{ zodResolver }, { preferencesSchema }] = await Promise.all([
    import('@hookform/resolvers/zod'),
    import('@community-go/schemas'),
  ]);
  return zodResolver(preferencesSchema)(values, context, options);
};
