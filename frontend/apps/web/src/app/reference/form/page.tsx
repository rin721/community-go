...
import type { ReferenceFormInput } from '@community-go/schemas';
...
const resolveReferenceForm: Resolver<ReferenceFormInput> = async (values, context, options) => {
  const [{ zodResolver }, { referenceFormSchema }] = await Promise.all([
    import('@hookform/resolvers/zod'),
    import('@community-go/schemas'),
  ]);
  return zodResolver(referenceFormSchema)(values, context, options);
};
