...
export function AdminBulkActionBar({
  ...
  return (
    <div
      ...
      className="admin-bulk-bar flex flex-wrap items-center justify-between gap-3 rounded-panel border border-brand/30 bg-brand-soft px-4 py-3 text-sm text-ink"
      role="toolbar"
    >
