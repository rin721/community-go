...
export type AdminDeploymentMode = 'static' | 'static-enumerated' | 'server';

/** 默认 Mode：static（与历史静态导出行为一致）。 */
export const DEFAULT_DEPLOYMENT_MODE: AdminDeploymentMode = 'static';
...
export function analyzeHostCapability(
  ...
  mode: AdminDeploymentMode = DEFAULT_DEPLOYMENT_MODE,
