/**
 * Admin Surface —— Navigation Group Alias 公共契约（plugins 范围公共 IA）。
 *
...
/** Group Alias 声明类型（与 framework contract 的 AdminNavigationGroupAlias 对齐）。 */
...
export const adminNavigationGroupAliases: readonly AdminNavigationGroupAlias[] = [
