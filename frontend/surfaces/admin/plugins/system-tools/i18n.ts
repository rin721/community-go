  ...
  'zh-CN': {
    translation: {
      systemTools: {
        ...
        icons: {
          title: 'Icon 大全',
          description: '遍历 Admin Surface 受控语义 icon vocabulary，确认每个 iconId 的展示形态。',
        },
        preferences: {
          eyebrow: '系统工具',
          title: '偏好设置',
    ...
    translation: {
      systemTools: {
        ...
        icons: {
          title: 'Icon Gallery',
          description:
            'Iterates the Admin Surface controlled semantic icon vocabulary and shows each iconId presentation.',
        },
        preferences: {
