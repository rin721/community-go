...
export type AuditFilter = { operation?: string; action?: string; outcome?: AuditOutcome; actorKind?: string; subjectHash?: string; resourceType?: string; since?: string; until?: string };
