...
func Binding() webui.Binding {
	...
	}, Navigation: []webui.Navigation{{ID: "iam.security", RouteID: "iam.security", TitleMessageID: "webui.iam.security.title", IconID: "user", Order: 30}, {ID: "iam.accounts", RouteID: "iam.accounts", TitleMessageID: "webui.iam.accounts.title", IconID: "users", Order: 40}, {ID: "iam.roles", RouteID: "iam.roles", TitleMessageID: "webui.iam.roles.title", IconID: "shield", Order: 50}, {ID: "iam.permissions", RouteID: "iam.permissions", TitleMessageID: "webui.iam.permissions.title", IconID: "key", Order: 60}}, Locales: []webui.Locale{{Language: "en-US", Namespace: "webui.iam", SourcePath: "locale/en-US.json"}, {Language: "zh-CN", Namespace: "webui.iam", SourcePath: "locale/zh-CN.json"}}, MockSource: "mock.ts", Requires: []webui.SDKRequirement{{ID: "runtime", MajorVersion: 1}, {ID: "http", MajorVersion: 1}, {ID: "i18n", MajorVersion: 1}, {ID: "ui", MajorVersion: 1}, {ID: "mock", MajorVersion: 1}}}
}
