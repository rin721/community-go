...
const (
	...
	SelfPreferencesRead     permissioncatalog.Key = "iam:account:self:preferences:read"
	SelfPreferencesWrite    permissioncatalog.Key = "iam:account:self:preferences:write"
