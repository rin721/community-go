...
import { Button, CapabilityBanner, DataTable, DataToolbar, EmptyState, Field, FilterPanel, PageHeader, Pagination, StatusPill, Toast } from "@webui/ui";
...
type CapabilityRow = { operation: OpsOperation; state: CapabilityState; result: string; pending: boolean; failed: boolean };
...
export default function CapabilitiesPage() {
  ...
  const rows: CapabilityRow[] = filteredOperations.map((operation) => {
    ...
    return { operation, state, pending: query.isPending, failed: query.isError, result: query.isPending ? t("webui.ops.capabilities.loading") : query.isError ? t("webui.ops.capabilities.failed") : resultPreview(query.data) };
  });
