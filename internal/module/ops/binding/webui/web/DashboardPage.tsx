...
export default function DashboardPage() {
  ...
  const queries = useGatedQueries({ queries: operations.map((operation) => ({ capability: operation.name, queryKey: ["ops", operation.name], queryFn: operation.query })) });
