...
- 无后端 Service/Repo/Migration；Profile/Account/Security 页面复用 IAM 既有 HTTP 能力（跨模块调用先例见 Organization 调 IAM accounts），Appearance/Notifications/Language 为前端偏好（localStorage/i18n）。
