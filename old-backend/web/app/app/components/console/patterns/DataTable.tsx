...
export function DataTable<TData>({ caption, columns, data, emptyLabel }: DataTableProps<TData>) {
  // eslint-disable-next-line react-hooks/incompatible-library -- TanStack Table is isolated behind the platform table pattern.
  ...
  return (
    <div className="console-data-table-wrap">
