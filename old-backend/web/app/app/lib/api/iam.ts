...
export type IAMNotificationOutboxListQuery = {
  kind?: string;
  page?: number;
  pageSize?: number;
  recipient?: string;
...
export const iamApi = {
  ...
  listNotificationOutbox: (
    query: IAMNotificationOutboxListQuery = {},
    options: RequestOptions = {},
  ) =>
    apiClient.request<IAMNotificationOutboxPage>(API_ENDPOINTS.iam.notificationOutbox, {
      query,
      signal: options.signal,
    }),
  ...
  retryNotificationOutbox: (outboxId: number | string, options: RequestOptions = {}) =>
    apiClient.request<IAMNotificationOutboxItem>(
      API_ENDPOINTS.iam.notificationOutboxRetry(outboxId),
      {
        method: "POST",
        signal: options.signal,
      },
