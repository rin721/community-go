...
const apiTokenErrorCopy = {
  defaultTitle: "admin.apiTokens.states.errorTitle",
  permissionDescription: "admin.apiTokens.states.permissionDescription",
  permissionTitle: "admin.apiTokens.states.permissionTitle",
  storageUnavailableDescription: "admin.apiTokens.states.storageUnavailableDescription",
  storageUnavailableTitle: "admin.apiTokens.states.storageUnavailableTitle",
};
...
export default function AdminAPITokensRoute() {
  ...
  const canCreateToken = hasSessionPermission(permissions, {
    code: "api_token:create",
    productCode: productCode || undefined,
    scope: "tenant",
  });
  const canRevokeToken = hasSessionPermission(permissions, {
  ...
  const revokeTokenMutation = useMutation({
    ...
    onError: (error, _token, context: { previousPage?: IAMAPITokenPage } | undefined) => {
      ...
      setNotice({
        description: adminErrorDescription(error, t, apiTokenErrorCopy),
        intent: "danger",
  ...
  const apiTokenPermissionDescription = useCallback(
    (permission: string) =>
      t("admin.apiTokens.states.writePermissionDescription", {
        permission,
      }),
    [t],
  );

  const setAPITokenPermissionNotice = useCallback(
    (permission: string) => {
      setNotice({
        description: apiTokenPermissionDescription(permission),
        intent: "danger",
        title: t("admin.apiTokens.states.permissionTitle"),
      });
    },
    [apiTokenPermissionDescription, t],
  );
  ...
  const tokenColumns = useMemo<ColumnDef<IAMAPIToken>[]>(
    () => [
      {
        accessorKey: "id",
        cell: ({ row }) => (
          <div className="console-api-token-id">
      ...
      },
      {
        accessorKey: "userId",
        cell: ({ row }) => (
          <div className="console-api-token-user">
      ...
      },
      {
        ...
        cell: ({ row }) => <code className="console-api-token-code">{row.original.roleCode}</code>,
      ...
      },
      {
        ...
        cell: ({ row }) =>
          row.original.lastUsedIpAddress ? (
            <code className="console-api-token-code">{row.original.lastUsedIpAddress}</code>
          ) : (
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const revokeDisabled =
            !canRevokeToken || apiTokenStatus(token) !== "active" || revokeTokenMutation.isPending;
          return (
            <div className="console-api-token-actions">
              <Button
                ...
                icon={<Ban size={16} />}
                title={
                  !canRevokeToken ? apiTokenPermissionDescription("api_token:revoke") : undefined
                }
                onClick={() => {
                  if (!canRevokeToken) {
                    setAPITokenPermissionNotice("api_token:revoke");
                    return;
                  }
    ...
    [
      apiTokenPermissionDescription,
      canRevokeToken,
      i18n.language,
      revokeTokenMutation.isPending,
      setAPITokenPermissionNotice,
      t,
    ],
  );
  ...
  const openIssuePanel = () => {
    if (!canCreateToken) {
      setAPITokenPermissionNotice("api_token:create");
      return;
    }
    setNotice(null);
    setIssueOpen(true);
  ...
  return (
    <section className="console-admin-dashboard" aria-labelledby="admin-api-tokens-title">
      <div className="console-admin-page-header">
        ...
        <div className="console-api-token-page-actions">
          <Button
            disabled={!currentOrgId || !canCreateToken}
            icon={<Plus size={17} />}
            title={!canCreateToken ? apiTokenPermissionDescription("api_token:create") : undefined}
      ...
      {apiTokensQuery.error ? (
        <StateBlock
          intent="danger"
          title={adminErrorTitle(apiTokensQuery.error, t, apiTokenErrorCopy)}
          description={adminErrorDescription(apiTokensQuery.error, t, apiTokenErrorCopy)}
        />
      ) : null}
      ...
      <Dialog
        ...
        footer={
          <div className="console-api-token-confirm-actions">
            <Button
      ...
      <div className="console-admin-stat-grid" aria-label={t("admin.apiTokens.summaryLabel")}>
        <APITokenStatCard
      ...
      {issueOpen ? (
        <section className="console-admin-panel">
          ...
          {metadataError ? (
            <StateBlock
              intent="danger"
              title={adminErrorTitle(metadataError, t, apiTokenErrorCopy)}
              description={adminErrorDescription(metadataError, t, apiTokenErrorCopy)}
            />
          ) : null}
          ...
          <form className="console-api-token-issue-form" onSubmit={submitIssue}>
            <SelectField
              disabled={!canCreateToken || metadataLoading || createTokenMutation.isPending}
            ...
            />
            <SelectField
              disabled={!canCreateToken || createTokenMutation.isPending}
            ...
            />
            <div className="console-form-field console-api-token-remark-field">
              ...
              />
              <span className="console-form-field__help">
                {t("admin.apiTokens.issue.remarkHelp")}
              </span>
            </div>
            <div className="console-api-token-issue-actions">
              <Button
                disabled={!canIssue}
      ...
      {issuedResult ? (
        <section className="console-admin-panel console-api-token-issued-panel">
          <header>
          ...
          />
          <div className="console-api-token-issued-grid">
            <div className="console-api-token-issued-block">
          ...
          <div className="console-api-token-issued-meta">
          ...
          <div className="console-api-token-issued-actions">
      ...
      <section className="console-admin-panel">
        ...
        <form
          className="console-admin-filter-form console-api-token-filter-form"
      ...
      <section className="console-admin-panel">
        <header className="console-admin-panel-header-row">
          ...
          <div className="console-admin-pager" aria-label={t("admin.apiTokens.pagination.label")}>
            <Button
              appearance="secondary"
        ...
        {apiTokensQuery.isLoading ? (
          ...
          <>
            ...
            <div className="console-api-token-table">
              <DataTable
