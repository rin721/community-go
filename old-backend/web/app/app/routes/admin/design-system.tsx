...
const storageKey = "console-platform-theme-draft";
...
export default function AdminDesignSystemRoute() {
  ...
  function exportDraft() {
    ...
    link.href = url;
    link.download = "console-theme-draft.json";
    link.click();
  ...
  return (
    <section className="console-admin-dashboard" aria-labelledby="admin-design-system-title">
      <div className="console-admin-page-header">
        ...
        <div className="console-theme-page-actions">
      ...
      <div className="console-admin-stat-grid" aria-label={t("admin.designSystem.summaryLabel")}>
      ...
      <div className="console-theme-layout">
        <section className="console-admin-panel console-theme-package-panel">
          <header>
            <h2>{t("admin.designSystem.package.title")}</h2>
            <p>{t("admin.designSystem.package.description")}</p>
          </header>
          <div className="console-theme-package-card">
        ...
        <section className="console-admin-panel console-theme-coverage-panel">
          <header>
            <h2>{t("admin.designSystem.coverage.title")}</h2>
            <p>{t("admin.designSystem.coverage.description")}</p>
          </header>
          <div className="console-theme-chip-list">
        ...
        <section className="console-admin-panel console-theme-recipe-panel">
          <header>
            <h2>{t("admin.designSystem.recipes.title")}</h2>
            <p>{t("admin.designSystem.recipes.description")}</p>
          </header>
          <div className="console-theme-card-grid">
            {recipeEntries.map(([key, recipe]) => (
              <article className="console-theme-source-card" key={key}>
        ...
        <section className="console-admin-panel console-theme-template-panel">
          <header>
        ...
        <section className="console-admin-panel console-theme-controls">
          <header>
            <h2>{t("admin.designSystem.controls.title")}</h2>
            <p>{t("admin.designSystem.controls.description")}</p>
          </header>

          <div className="console-theme-control-grid">
            <SelectField
          ...
          <div className="console-theme-color-grid">
            {(["primaryColor", "accentColor", "surfaceColor", "textColor"] as ColorTokenKey[]).map(
              (key) => (
                <div className="console-theme-color-field" key={key}>
                  <FormField
        ...
        <section className="console-admin-panel console-theme-preview-panel">
          <header>
            <h2>{t("admin.designSystem.preview.title")}</h2>
            <p>{t("admin.designSystem.preview.description")}</p>
          </header>
          <div className="console-theme-preview" data-mode={draft.mode} style={previewStyle}>
            <div className="console-theme-preview__surface">
              ...
              <div className="console-theme-preview__actions">
            ...
            <div className="console-theme-preview__module">
        ...
        <section className="console-admin-panel console-theme-import-panel">
          ...
          <div className="console-form-field">
            ...
            />
            <span className="console-form-field__help">{t("admin.designSystem.import.help")}</span>
          </div>
        ...
        <section className="console-admin-panel console-theme-release-panel">
          <header>
            <h2>{t("admin.designSystem.release.title")}</h2>
            <p>{t("admin.designSystem.release.description")}</p>
          </header>
          <div className="console-theme-diff" aria-label={t("admin.designSystem.diff.label")}>
          ...
          <div className="console-theme-release-actions">
...
function ThemeRangeField({
  ...
  return (
    <div className="console-theme-range-field">
      <FormField
        help={help}
        label={label}
        max={max}
