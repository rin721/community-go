...
const organizationErrorCopy = {
  defaultTitle: "admin.organizations.states.errorTitle",
  permissionDescription: "admin.organizations.states.permissionDescription",
  permissionTitle: "admin.organizations.states.permissionTitle",
  storageUnavailableDescription: "admin.organizations.states.storageUnavailableDescription",
  storageUnavailableTitle: "admin.organizations.states.storageUnavailableTitle",
};
...
export default function AdminOrganizationsRoute() {
  ...
  const canCreateOrganization = hasSessionPermission(permissions, {
    code: "org:create",
    productCode: productCode || undefined,
    scope: "platform",
  });
  const canUpdateCurrentOrganization = hasSessionPermission(permissions, {
    code: "org:update",
    productCode: productCode || undefined,
    scope: "tenant",
  });
  ...
  const organizationPermissionDescription = useCallback(
    (scope: "platform" | "tenant", permission: string) =>
      t("admin.organizations.states.writePermissionDescription", {
        permission,
        scope,
      }),
    [t],
  );
  const setOrganizationPermissionNotice = useCallback(
    (scope: "platform" | "tenant", permission: string) => {
      setNotice({
        description: organizationPermissionDescription(scope, permission),
        intent: "danger",
        title: t("admin.organizations.states.permissionTitle"),
      });
    },
    [organizationPermissionDescription, t],
  );
  ...
  const createOrganizationMutation = useMutation({
    ...
    onError: (error) => {
      setNotice({
        description: adminErrorDescription(error, t, organizationErrorCopy),
        intent: "danger",
    ...
    () => [
      {
        accessorKey: "code",
        cell: ({ row }) => (
          <div className="console-org-identity">
  ...
  function handleCreate(event: FormEvent<HTMLFormElement>) {
    ...
    if (!canCreateOrganization) {
      setOrganizationPermissionNotice("platform", "org:create");
      return;
    }
  ...
  function handleUpdateCurrent(event: FormEvent<HTMLFormElement>) {
    ...
    if (!canUpdateCurrentOrganization) {
      setOrganizationPermissionNotice("tenant", "org:update");
      return;
    }
  ...
  const queryError = organizationsQuery.error;
  const isMutating =
  ...
  return (
    <section className="console-admin-dashboard">
      <header className="console-admin-page-header">
        ...
        <div className="console-admin-action-row console-org-page-actions">
          <Button
            appearance="secondary"
      ...
      <div className="console-admin-stat-grid" aria-label={t("admin.organizations.summaryLabel")}>
      ...
      {queryError ? (
        <StateBlock
          title={adminErrorTitle(queryError, t, organizationErrorCopy)}
          description={adminErrorDescription(queryError, t, organizationErrorCopy)}
          intent="danger"
        />
        ...
        <div className="console-org-workbench">
          <section className="console-admin-panel console-admin-panel--span-2">
            ...
            <form
              className="console-admin-filter-form console-org-filter-form"
          ...
          <section className="console-admin-panel console-admin-panel--span-2">
            ...
            <div className="console-org-table">
              <DataTable
          ...
          <section className="console-admin-panel">
            ...
            <form className="console-org-form" onSubmit={handleUpdateCurrent}>
              <FormField
                disabled
                label={t("admin.organizations.fields.code")}
              ...
              <FormField
                label={t("admin.organizations.fields.name")}
                disabled={!canUpdateCurrentOrganization || isMutating}
                value={currentName}
                onChange={(event) => setCurrentNameDraft(event.target.value)}
              />
              <Button
                disabled={isMutating || !canUpdateCurrentOrganization || !currentName.trim()}
                icon={<Save size={17} />}
                loading={updateOrganizationMutation.isPending}
                title={
                  !canUpdateCurrentOrganization
                    ? organizationPermissionDescription("tenant", "org:update")
                    : undefined
                }
                type="submit"
              >
          ...
          <section className="console-admin-panel">
            ...
            <form className="console-org-form" onSubmit={handleCreate}>
              <FormField
                disabled={!canCreateOrganization || isMutating}
                label={t("admin.organizations.fields.code")}
              ...
              <Button
                ...
                title={
                  !canCreateOrganization
                    ? organizationPermissionDescription("platform", "org:create")
                    : undefined
                }
                type="submit"
              >
