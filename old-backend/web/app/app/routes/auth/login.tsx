...
export default function LoginRoute() {
  ...
  const signupVisible = registrationMode === "direct" || registrationMode === "email_verification";
  ...
  return (
    <main className="console-auth-page">
      <section className="console-auth-card" aria-labelledby="login-title">
        ...
        <ConsoleForm form={form} onSubmit={onSubmit}>
          <ConsoleTextField<LoginFormValues>
          ...
          />
          {challenge === "captcha" ? (
            <div className="console-auth-challenge">
              <div className="console-auth-challenge__header">
                <h2 id="login-captcha-title">{t("auth.login.captchaTitle")}</h2>
                <p>{t("auth.login.captchaDescription")}</p>
              </div>
              <div className="console-auth-captcha">
                {captcha?.image ? (
                  <img
                    alt={t("auth.login.captchaImageAlt")}
                    className="console-auth-captcha__image"
                    src={captcha.image}
                  />
                ) : null}
                <Button
