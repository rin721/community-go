...
export const KNOWN_TOKENS = [
  ...
  "font-scale-15", "font-scale-lg", "font-scale-xl", "font-scale-metric-value", "font-scale-page-title",
  ...
  "radius-12", "radius-xl", "radius-pill", "radius-round", "state-indicator-width", "progress-track-height",
